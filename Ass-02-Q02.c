...
//		//Buttons
//		{(uint8_t *)"0",	{0,		64,		192, 	240},	(uint8_t *)&Font24,	LCD_COLOR_GRAY, LCD_COLOR_GRAY,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//		{(uint8_t *)"1",	{0,		64,		144,	192},	(uint8_t *)&Font24,	LCD_COLOR_GRAY, LCD_COLOR_GRAY,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//		{(uint8_t *)"2",	{64,	128,	144,	192},	(uint8_t *)&Font24,	LCD_COLOR_GRAY, LCD_COLOR_GRAY,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//		{(uint8_t *)"3",	{128,	192,	144,	192},	(uint8_t *)&Font24,	LCD_COLOR_GRAY, LCD_COLOR_GRAY,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//		{(uint8_t *)"4",	{0,		64,		96,		144},	(uint8_t *)&Font24,	LCD_COLOR_GRAY, LCD_COLOR_GRAY,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//		{(uint8_t *)"5",	{64,	128,	96,		144},	(uint8_t *)&Font24,	LCD_COLOR_GRAY, LCD_COLOR_GRAY,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//		{(uint8_t *)"6",	{128,	192,	96,		144},	(uint8_t *)&Font24,	LCD_COLOR_GRAY, LCD_COLOR_GRAY,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//		{(uint8_t *)"7",	{0,		64,		48,		96},	(uint8_t *)&Font24,	LCD_COLOR_GRAY, LCD_COLOR_GRAY,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//		{(uint8_t *)"8",	{64,	128,	48,		96},	(uint8_t *)&Font24,	LCD_COLOR_GRAY, LCD_COLOR_GRAY,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//		{(uint8_t *)"9",	{128,	192,	48,		96},	(uint8_t *)&Font24,	LCD_COLOR_GRAY, LCD_COLOR_GRAY,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//		{(uint8_t *)".",	{64,	128,	192,	240},	(uint8_t *)&Font24,	LCD_COLOR_GRAY, LCD_COLOR_GRAY,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//
//		//Operators
//		{(uint8_t *)"+/-",	{128,	192,	192,	240},	(uint8_t *)&Font24,	LCD_COLOR_GRAY,	LCD_COLOR_GRAY,			  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//		{(uint8_t *)"%",	{192,	256,	144,	192},	(uint8_t *)&Font24,	LCD_COLOR_ORANGE, 		LCD_COLOR_ORANGE ,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_Mod},
//		{(uint8_t *)"+",	{192,	256,	96,		144},	(uint8_t *)&Font24,	LCD_COLOR_ORANGE, 		LCD_COLOR_ORANGE ,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_Add},
//		{(uint8_t *)"X",	{192,	256,	48,		96},	(uint8_t *)&Font24,	LCD_COLOR_ORANGE, 		LCD_COLOR_ORANGE ,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_Mul},
//		{(uint8_t *)"=",	{192,	256,	192,	240},	(uint8_t *)&Font24,	LCD_COLOR_ORANGE, 		LCD_COLOR_ORANGE ,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//		{(uint8_t *)"C",	{256,	320,	144,	192},	(uint8_t *)&Font24,	LCD_COLOR_ORANGE, 		LCD_COLOR_ORANGE ,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12}, &Calc_0},
//		{(uint8_t *)"-",	{256,	320,	96,		144},	(uint8_t *)&Font24,	LCD_COLOR_ORANGE, 		LCD_COLOR_ORANGE ,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12}, &Calc_Sub},
//		{(uint8_t *)"/",	{256,	320,	48,		96},	(uint8_t *)&Font24,	LCD_COLOR_ORANGE, 		LCD_COLOR_ORANGE ,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12}, &Calc_Div},
//		{(uint8_t *)"AC",	{256,	320,	192,	240},	(uint8_t *)&Font24,	LCD_COLOR_ORANGE, 		LCD_COLOR_ORANGE ,  LCD_COLOR_BLACK,	CENTER_MODE,	{0, 12},	&Calc_0},
//
//		//Result Field
